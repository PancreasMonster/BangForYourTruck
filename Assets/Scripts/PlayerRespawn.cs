...
public class PlayerRespawn : MonoBehaviour
{
    ...
    public IEnumerator FallPlayer1(Transform carRB)
    {
        ...
        player1.GetComponent<Orbit>().death = true;
        player1.GetComponent<Orbit>().carDeath = carRB;
        player1Timer = deathTimer;
        player1Death = true;
        yield return new WaitForSeconds(deathTimer);
        player1.GetComponent<Orbit>().death = false;
        player1.transform.position = player1StartPos;
        player1.GetComponent<Rigidbody>().velocity = Vector3.zero;
        player1.GetComponent<Rigidbody>().angularVelocity = Vector3.zero;
    ...
    public IEnumerator FallPlayer2(Transform carRB)
    {
        ...
        player2.GetComponent<Orbit>().death = true;
        player2.GetComponent<Orbit>().carDeath = carRB;
        player2Timer = deathTimer;
        player2Death = true;
        yield return new WaitForSeconds(deathTimer);
        player2.GetComponent<Orbit>().death = false;
        player2.transform.position = player2StartPos;
        player2.GetComponent<Rigidbody>().velocity = Vector3.zero;
        player2.GetComponent<Rigidbody>().angularVelocity = Vector3.zero;
    ...
    public IEnumerator FallPlayer3(Transform carRB)
    {
        ...
        player3.GetComponent<Orbit>().death = true;
        player3.GetComponent<Orbit>().carDeath = carRB;
        player3Timer = deathTimer;
        player3Death = true;
        yield return new WaitForSeconds(deathTimer);
        player3.GetComponent<Orbit>().death = false;
    ...
    public IEnumerator FallPlayer4(Transform carRB)
    {
        ...
        player4.GetComponent<Orbit>().death = true;
        player4.GetComponent<Orbit>().carDeath = carRB;
        player4Timer = deathTimer;
        player4Death = true;
        yield return new WaitForSeconds(deathTimer);
        player4.GetComponent<Orbit>().death = false;
